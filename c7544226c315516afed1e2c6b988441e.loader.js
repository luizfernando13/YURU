function createUnityInstance(r, t, l) {
    ...
    function n(e) {
        ...
        (t += "\n" + (n = n.startsWith(t) ? n.substring(t.length) : n).trim()) && g.stackTraceRegExp && g.stackTraceRegExp.test(t) && f(t, e.filename || r && (r.fileName || r.sourceURL) || "", e.lineno || r && (r.lineNumber || r.line) || 0)
    }
    function e(e, r, t) {
        var n = e[r];
    ...
    t)
        g[o] = t[o];
    g.streamingAssetsUrl = new URL(g.streamingAssetsUrl,document.URL).href;
    var a = g.disabledCanvasEvents.slice();
    function i(e) {
        e.preventDefault()
    }
    ...
    g.deinitializers.push(function() {
        for (var e in g.disableAccessToMediaDevices(),
        a.forEach(function(e) {
    ...
    var h = {
        ...
        GetMetricsInfo: function() {
            ...
            return {
                ...
                pageLoadTimeToFrame1: g.HEAPU32[a >> 2],
                fps: g.HEAPF64[i >> 3],
        ...
        if ("symbolsUrl" != e) {
            ...
            for (e in g.downloadProgress) {
                if (!(t = g.downloadProgress[e]).started)
                    return;
                a++,
                t.lengthComputable ? (n += t.loaded,
                o += t.total,
                i++) : t.finished || s++
            }
            l(.9 * (a ? (a - s - (o ? i * (o - n) / o : 0)) / a : 0))
        }
    }
    g.SystemInfo = function() {
        var e, r, t, n, o, a = navigator.userAgent + " ", i = [["Firefox", "Firefox"], ["OPR", "Opera"], ["Edg", "Edge"], ["SamsungBrowser", "Samsung Browser"], ["Trident", "Internet Explorer"], ["MSIE", "Internet Explorer"], ["Chrome", "Chrome"], ["CriOS", "Chrome on iOS Safari"], ["FxiOS", "Firefox on iOS Safari"], ["Safari", "Safari"]];
        function s(e, r, t) {
        ...
        "Safari" == e && (r = s("Version/(.*?) ", a, 1)),
        "Internet Explorer" == e && (r = s("rv:(.*?)\\)? ", a, 1) || r);
        ...
        webgpuVersion = 0,
        (f = document.createElement("canvas")) && (c = (p = f.getContext("webgl2")) ? 2 : 0,
        p || (p = f && f.getContext("webgl")) && (c = 1),
    ...
    g.readBodyWithProgress = function(a, i, s) {
        ...
        function o() {
            return void 0 === e ? a.arrayBuffer().then(function(e) {
                ...
                if (e.done) {
                    ...
                    if (h < d)
                        return u.slice(0, h);
                    for (var r = new Uint8Array(h), t = (r.set(u, 0),
                    f), n = 0; n < c.length; ++n)
                        r.set(c[n], t),
                        t += c[n].length;
                    return r
    ...
    var b = {
        ...
        br: {
            hasUnityMarker: function(e) {
                ...
                if (commentOffset = 1 + t + 2 + 1 + 2 + (o << 3) + 7 >> 3,
                17 == n || commentOffset > e.length)
                    return !1;
                for (var a = n + (6 + (o << 4) + (r.length - 1 << 6) << t), i = 0; i < commentOffset; i++,
                a >>>= 8)
                    if (e[i] != (255 & a))
                        return !1;
    ...
    function p() {
        var r, e, s, t, n = performance.now(), p = (new Promise(function(a, e) {
            var i = document.createElement("script");
            i.src = g.frameworkUrl,
            i.onload = function() {
                if ("undefined" == typeof unityFramework || !unityFramework) {
                    ...
                    for (e in r) {
                        ...
                        if (g.frameworkUrl.endsWith("." + n[0]))
                            return t = "Unable to parse " + g.frameworkUrl + "!",
                            "file:" == location.protocol ? void d(t + " Loading pre-compressed (brotli or gzip) content via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host compressed Unity content, or use the Unity Build and Run option.", "error") : (t += ' This can happen if build compression was enabled but web server hosting the content was misconfigured to not serve the file with HTTP Response Header "Content-Encoding: ' + n[1] + '" present. Check browser Console and Devtools Network tab to debug.',
        ...
        performance.now()), o = (m(r = "dataUrl"),
        e = g.fetchWithProgress,
        s = g[r],
        t = /file:\/\//.exec(s) ? "same-origin" : void 0,
        e(g[r], {
            method: "GET",
        ...
        g.preRun.push(function() {
            ...
            o.then(function(r) {
                ...
                var a = "UnityWebData1.0\0"
                  , i = e.decode(r.subarray(0, a.length))
                ...
                for (t + s > r.length && o("Invalid binary data file header! (pos=" + t + ", headerSize=" + s + ", file length=" + r.length + ")"); t < s; ) {
                    var l = n()
                      , d = n()
                      , u = (l + d > r.length && o("Invalid binary data file size! (offset=" + l + ", size=" + d + ", file length=" + r.length + ")"),
                    n())
                      , c = (t + u > r.length && o("Invalid binary data file path name! (pos=" + t + ", length=" + u + ", file length=" + r.length + ")"),
                    e.decode(r.subarray(t, t + u)));
                    t += u;
                    for (var h = 0, f = c.indexOf("/", h) + 1; 0 < f; h = f,
                    f = c.indexOf("/", h) + 1)
    ...
    return new Promise(function(e, r) {
        var t;
        g.SystemInfo.hasWebGL ? 1 == g.SystemInfo.hasWebGL ? (t = 'Your browser does not support graphics API "WebGL 2" which is required for this content.',
        "Safari" == g.SystemInfo.browser && parseInt(g.SystemInfo.browserVersion) < 15 && (g.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? t += "\nUpgrade to iOS 15 or later." : t += "\nUpgrade to Safari 15 or later."),
        r(t)) : g.SystemInfo.hasWasm ? g.SystemInfo.hasWasm2023 ? (g.startupErrorHandler = r,
        l(0),
        g.postRun.push(function() {
            l(1),
